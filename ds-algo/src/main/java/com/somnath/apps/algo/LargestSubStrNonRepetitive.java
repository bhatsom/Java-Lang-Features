...
public class LargestSubStrNonRepetitive {
	...
	static int longestNonRepSubStr(String str) {
		...
		System.out.println("charAtZero: " + str.charAt(0));
		System.out.println("charAtZeroVisited1: " + visited[str.charAt(0)]);
		visited[str.charAt(0)] = 0;
		System.out.println("charAtZeroVisited2: " + visited[str.charAt(0)]);
		...
		for (i = 1; i < n; i++) {
            ...
            /* If the current character is present in currently considered NRCS, then update NRCS to start from
               the next character of previous instance. */
                ...
                /* Also, when we are changing the NRCS, we should also check whether length of the previous NRCS was
