...
public class BinarySearchTree {
    ...
    public Node insertItem(Node node, int key, String value) {
        ...
        // IF: Root Node is null, make it root. We are done.
        if (node == null) {
        ...
        // We have returned from the bottom. Return our fully constructed tree. We are done!
        return node;
    }
    ...
    public Node delete(Node node, int key) {
        if (node == null) {
            ...
            // Case 3: Two children
                ...
                // Find the minimum node on the right (could also be max on the left...)
